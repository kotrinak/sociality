...
# import data
dat <- read.csv( paste0("Data/directed_groom_matrix_", dataset_label[dataset],".csv" ), stringsAsFactors = F )
...
# save  
save.image( file=paste0("m0_",dataset_label[dataset],"_groom.RDATA" ) )
